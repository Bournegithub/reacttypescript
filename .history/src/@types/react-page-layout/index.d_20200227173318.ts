...
declare module 'react-page-layout' {
    ...
    declare namespace LayoutProvider {
        declare namespace childContextTypes {
            export function getLayout(p0: any, p1: any, p2: any, p3: any, p4: any, p5: any): any;
        }
    ...
    declare namespace Page {
        declare namespace contextTypes {
            declare function getLayout(name:string): any;
        }
    }
